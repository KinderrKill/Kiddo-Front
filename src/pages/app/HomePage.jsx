...
const CURRENT_DATE = new Date(2022, 6, 1).getTime()
    ...
    <>
      ...
      <section>
        <article className='section__grid-4 mb-16 gap-8 mx-8 mt-2 md:-mt-10'>
          <button className='main-button green-bg-gradient lg:col-start-2' onClick={navigateHandler}>
            Participer aux activités
          </button>
          <button className='main-button blue-bg-gradient lg:col-start-3' onClick={navigateHandler}>
        ...
        <article className='generic-container home-section'>
          <div className='flex flex-col md:flex-row justify-between items-center mb-5'>
            ...
            <div className='flex items-center'>
              ...
              <button className='md:ml-4 md:mr-10 text-xl md:text-2xl underline' onClick={navigateHandler}>
      ...
      <section>
        <article className='generic-container home-section'>
          <div className='flex flex-col md:flex-row justify-between items-center mb-5'>
            ...
            <div className='flex items-center'>
              <button className='md:ml-4 md:mr-10 mt-5 md:mt-0 text-xl md:text-2xl underline' onClick={navigateHandler}>
